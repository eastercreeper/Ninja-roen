package com.github.eastercreeper.ninjaroen.main.utils;
...
public class arch {
    ...
    public static ArrayList<Module> longShort () {;
        ArrayList<Module> hackModules = cp(ninjaroen.instance.moduleManager.modules);
    ...
    public static ArrayList<Module> abcList() {
        ...
        for (String str : modNames) {
            for (Module mod : ninjaroen.instance.moduleManager.getModulesList()) {
    ...
    public static ArrayList<String> modNamesPLS () {
        ...
        for (Module m : ninjaroen.instance.moduleManager.getModulesList()) {
