package com.github.eastercreeper.ninjaroen.main.clickgui.component.components;

import java.awt.Color;
import java.util.ArrayList;

import com.github.eastercreeper.ninjaroen.main.clickgui.ClickGUI;
import com.github.eastercreeper.ninjaroen.main.clickgui.component.Component;
import com.github.eastercreeper.ninjaroen.main.clickgui.component.Frame;
import com.github.eastercreeper.ninjaroen.main.clickgui.component.components.sub.*;
...
public class Button extends Component {
    ...
    public Button(Module mod, Frame parent, int offset) {
        ...
        height = 12;
        int opY = offset + 12;
        if(ninjaroen.instance.settingsManager.getSettingsByMod(mod) != null) {
            for(Setting s : ninjaroen.instance.settingsManager.getSettingsByMod(mod)){
                if(s.isCombo()){
